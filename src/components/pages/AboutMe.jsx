      ...
      <div className='about-me__page_content'>
        ...
        <main className='about-me__flex-container'>
          ...
          <p className='about-me__owner__description'>
            ...
            Beyond the screen, I wield my passion at GDSC, threading connections
            and guiding fellow enthusiasts through the maze of tech
            possibilities. I find joy in guiding fellow enthusiasts and building
            networks that transcend the digital divide.
          </p>
          <p className='about-me__owner__description'>
          ...
          <p className="about_me__skills__list">
              <ul className="about_me__skills__list-items">
                ...
                <li><img src="/Right_Arrow.png" className="about_me__skills__list__right-arrow" alt="right_arrow" />Flutter</li>
                <li><img src="/Right_Arrow.png" className="about_me__skills__list__right-arrow" alt="right_arrow" />Figma</li>
              </ul>
              <ul className="about_me__skills__list-items">
                <li><img src="/Right_Arrow.png" className="about_me__skills__list__right-arrow" alt="right_arrow" />Java</li>
                <li><img src="/Right_Arrow.png" className="about_me__skills__list__right-arrow" alt="right_arrow" />Python</li>
